...
class MiniCode {
    ...
    constructor(root){
        ...
        desk.src = require("a8db8cd3c7821e9d");
        const key = new Image();
        key.src = require("eb6cf9e1a50fa2a9");
        const spacebar = new Image();
        spacebar.src = require("ffdfe9c77c099bb4");
        const penalties = new Image();
        penalties.src = require("a7b6cc0f0c2641b1");
        const bugs = new Image();
        bugs.src = require("18c7b82dc19e09ab");
        this.#assets = {
            lorem,
            desk,
            key,
...
},{"4c286ba0c1da238f":"jPil8","a8db8cd3c7821e9d":"kSZqS","eb6cf9e1a50fa2a9":"g4D5i","ffdfe9c77c099bb4":"jSBvT","a7b6cc0f0c2641b1":"83BJK","18c7b82dc19e09ab":"2tMyp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jPil8":[function(require,module,exports) {
module.exports = require("ef84b8ceb3179804").getBundleURL("eI7dW") + "lorem.757e7205.png" + "?" + Date.now();

},{"ef84b8ceb3179804":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"kSZqS":[function(require,module,exports) {
module.exports = require("6914580950cad940").getBundleURL("eI7dW") + "desk.144852c4.png" + "?" + Date.now();

},{"6914580950cad940":"lgJ39"}],"g4D5i":[function(require,module,exports) {
module.exports = require("1cb537b381090d1a").getBundleURL("eI7dW") + "key.226e069b.png" + "?" + Date.now();

},{"1cb537b381090d1a":"lgJ39"}],"jSBvT":[function(require,module,exports) {
module.exports = require("a11f29c93dbfb5a2").getBundleURL("eI7dW") + "spacebar.a0b1f82b.png" + "?" + Date.now();

},{"a11f29c93dbfb5a2":"lgJ39"}],"83BJK":[function(require,module,exports) {
module.exports = require("8a043fc088097e4").getBundleURL("eI7dW") + "penalties.5e759721.png" + "?" + Date.now();

},{"8a043fc088097e4":"lgJ39"}],"2tMyp":[function(require,module,exports) {
module.exports = require("3bc80af743de6612").getBundleURL("eI7dW") + "bugs.ad4a601c.png" + "?" + Date.now();

},{"3bc80af743de6612":"lgJ39"}],"gkKU3":[function(require,module,exports) {
